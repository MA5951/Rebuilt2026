...
//TODO you need to clean all the setPointgenertor 
public class SwerveSetPointGeneratorMA {
   ...
   *     direction.
   */
  public SwerveSetPointGeneratorMA(SwerveDriveKinematics newKine , Translation2d[] locations) {
    kinematics = newKine;
  ...
  public SwerveSetpoint generateSetpoint(
    ...
    for (int i = 0; i < modules.length; ++i) {
      if (!need_to_steer) { //!need_to_steer
