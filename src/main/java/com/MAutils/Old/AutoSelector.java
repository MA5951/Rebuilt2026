...
//     private DoubleArrayPublisher pathPub = NetworkTableInstance.getDefault().getDoubleArrayTopic("/MALog/Dashboard/Auto/Selected Path")
//             .publish();
...
//     public AutoSelector setRobotPoseSupplier(Supplier<Pose2d> robotPoseSupplier) {
//         poseSupplier = robotPoseSupplier;
//         return this;
//     }

//     public AutoSelector setAutoOptions(AutoOption[] options, boolean preViz) {
...
//             MALog.log("Dashboard/Auto/Starting Pose", FlippingUtil.flipFieldPose(getSelectedAutoStartingPose()));
//             return poseSupplier.get().getTranslation().getDistance(FlippingUtil.flipFieldPose(getSelectedAutoStartingPose()).getTranslation()) < 0.2;
            
//         }

//         MALog.log("Dashboard/Auto/Starting Pose", getSelectedAutoStartingPose());
//         return poseSupplier.get().getTranslation().getDistance(getSelectedAutoStartingPose().getTranslation()) < 0.2;
...
//     private void setCurrentPath(PathPlannerPath path) {
...
//         if (preVizualizAuto) {
//                 if (lastPublishedAuto != getSelectedAuto().getPathPlannerAutoName() && getSelectedAuto().getPathPlannerAutoName() != "" && getSelectedAuto().getPathPlannerAutoName() != null) {
//                     clearCurrentPath();
