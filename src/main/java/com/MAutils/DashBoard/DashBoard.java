...
/*
 * Utility class for interacting with the Elastic dashboard.
 */
//TODO add MADashoard
public class DashBoard {
  ...
  public static void sendNotification(NotificationLevel notificationLevel, String title, String description) {
    try {
      notificationPublisher.set(objectMapper.writeValueAsString(new Notification(notificationLevel, title, description)));
    } catch (JsonProcessingException e) {
      e.printStackTrace();
    }
  }
