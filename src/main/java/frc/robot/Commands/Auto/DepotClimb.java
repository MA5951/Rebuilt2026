...
public class DepotClimb extends SequentialCommandGroup {
  ...
  private double deltaDriveNum = 0.03;

  public DepotClimb() {
    addCommands(
      SwerveAutoFollower.followPath("DC 1 Push"),
      new InstantCommand(() -> RobotConstants.SHOOTING.setState()),
      new ParallelDeadlineGroup(new WaitCommand(6), new SwerveAutoController()),
      ...
      new WaitUntilCommand(() -> Swerve.getInstance().isModuleStuck() ),
      new Drive(0.5, -0.1, 0)),
