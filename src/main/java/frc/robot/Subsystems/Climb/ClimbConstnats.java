...
public class ClimbConstnats {
    ...
    public static final double PRECLIMB_POSITION = 10;
    ...
    private static final Motor CLIMB_MOTOR = new Motor(PortMap.ClimbPorts.CLIMB_MOTOR, MotorType.KRAKEN, "Climb Motor",
