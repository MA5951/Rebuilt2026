...
public static final double WARMUP_VELOCITY = 0;
 ...
 public static final Motor shooterMasterMotor = new Motor(PortMap.ShooterPorts.SHOOTER_MASTER, MotorType.KRAKEN, "Shooter Master Motor", InvertedValue.Clockwise_Positive);

public static final Motor shooterSlaveMotor = new Motor(PortMap.ShooterPorts.SHOOTER_SLAVE, MotorType.KRAKEN, "Shooter Slave Motor", InvertedValue.Clockwise_Positive);
 ...
 .newBuilder("Shooter", REAL_GAIN_CONFIG, shooterMasterMotor, shooterSlaveMotor)
 .gear(0)
 .isBrake(false)
 .tolerance(0)
 .motorCurrentLimit(0)
