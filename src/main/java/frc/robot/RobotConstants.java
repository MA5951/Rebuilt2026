...
public class RobotConstants {
        ...
        public static final MRobotState IDLE = new MRobotState("IDLE",
                        ...
                        RollerConstants.IDLE, HoodConstants.IDLE, ClimbConstnats.IDLE, TransferConstants.IDLE, KickerConstants.IDLE);

        public static final MRobotState IDLE_INTAKE = new MRobotState("IDLE_INTAKE",
                        IntakeRollerConstants.IDLE, SandwichConstants.IDLE,
                        RollerConstants.IDLE, HoodConstants.IDLE, TransferConstants.IDLE, ClimbConstnats.IDLE, KickerConstants.IDLE);
        ...
        public static final MRobotState FEEDING_IN_MOTION = new MRobotState("FEEDING_IN_MOTION", () -> {
                if (SixBar.getInstance().getCurrentState() != SixBarConstants.ARMBRAKS) {
                        ...
                        HoodConstants.FEEDING_IN_MOTION,IntakeRollerConstants.FORWARD, KickerConstants.FEEDING_IN_MOTION);
        ...
        public static final MRobotState PRECLIMB = new MRobotState("PRECLIMB",
                        ...
                        ShooterConstants.IDLE, SandwichConstants.IDLE, RollerConstants.IDLE, TransferConstants.IDLE, KickerConstants.IDLE);
